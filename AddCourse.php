...
//inserts details from form to table in database
$sql = "INSERT INTO courses (course_name, date, price, description,image_path) VALUES('".$course_name."','".$date."','".$price."','".$description."','".$image_path."')"; 
