...
<main>
    <h2 id="reg_header">Book Event</h2>
    <form action ="BookingEvent.php?event_price=<?php echo $event_price ?>&event_id=<?php echo $event_id ?>"  id="form"  method ="POST">
        <fieldset>
